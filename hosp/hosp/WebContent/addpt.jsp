	...
	<%
 	try {
 		...
 		if (a.equals("SEARCH PATIENT")) {//if0
 			...
 			Connection c = DriverManager.getConnection("jdbc:mysql://localhost:3306/hospital?useSSL=false", "root", "root");
 			Statement s = c.createStatement();
 			if (str1 != "") {//if1
 				String sql2 = "select * from patient where p_id='" + str1 + "'";
			...
			if (a.equals("EDIT PATIENT DETAILS")) {
				...
				if (str1 != "") {
					...
					if (rs1.next()) {
						...
						if (rs.next()) {
							String sq = "delete from patient where p_id='" + str1 + "'";
							s.execute(sq);
 		...
 		if (a.equals("ADMIT PATIENT AND ALLOT BED")) {//if1
 			...
 			{//if2
 				...
 				//if (r4.next()) {//if 3
 					...
 					String sq2 = "select * from bed_occupied where bed_no =" + str12 + "";
			...
			<%
 					...
 					String sq3 = "insert into bed_occupied values(" + str11 + ",'" + str12 + "','" + str13+ "','" + str14 + "','" + str15 + "')";
 					//out.println(sq3);
 					s.execute(sq3);
 			%>
 			<script language="javascript">
						...
						<table border="1">
							...
							<%
								try {
									...
									Connection c = DriverManager.getConnection("jdbc:mysql://localhost:3306/hospital?useSSL=false", "root", "root");
									Statement s = c.createStatement();
									String sql1 = "select * from bed_occupied";
									ResultSet rs = s.executeQuery(sql1);
									while (rs.next()) {
							%><tr>
